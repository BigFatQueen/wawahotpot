...
//show edit form of expense
    $('#expenseTable').on('click','.btnEdit',function(){
      // alert('i am edit');
        var id=$(this).data('id');
        var url="<?php echo e(route('expense.show',':id')); ?>";
...
//search submitting
    ...
    //start here order
     function getOrder(){
    var url="<?php echo e(route('getOrder')); ?>";
    $.get(url,function(response){
  ...
  $('#ordertable').on('click','.btn-Delete',function(){
    var id=$(this).data('id');
      var url="<?php echo e(route('orderDestory',':id')); ?>";
      url=url.replace(':id',id);
    ...
    $('#ordertable').on('click','.btn-Detail',function(){
        ...
        var url="<?php echo e(route('getOrderDetailByV')); ?>";
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('backend/backend_dashboard_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/prj/wawahotpot/resources/views/backend/admin-dashboard.blade.php ENDPATH**/ ?>