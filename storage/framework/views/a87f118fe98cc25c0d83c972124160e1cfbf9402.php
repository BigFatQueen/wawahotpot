   ...
   toastr.options.closeButton = true;
    ...
    $('#meat').on('click','.btn-edit',function(){
     ...
     $.get(url,function(response){
      ...
      var image="<?php echo e(asset(':img')); ?>";
...
<?php echo $__env->make('backend/backend_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/prj/wawahotpot/resources/views/backend/menu/vegetable_index.blade.php ENDPATH**/ ?>