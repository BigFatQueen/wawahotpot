    ...
    <div class="modal-dialog modal-dialog-srcollable  modal-md" role="document">
        <div class="modal-content bg-white">
            ...
            <div class="text-dark text-center">
                <h1 class="my-2 d-inline">Wa Wa  Hotpot</h1>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
...
<div class="modal fade" id="slip-modals" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable" role="document">
     <div class="modal-content bg-white">
      ...
      <div class="modal-body table-responsive">
            <table class="table  text-dark table-wrapper-scroll-y my-custom-scrollbar">
                <thead>
                    <tr>
                        <th>Description</th>
                        <th>Qty</th>
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/prj/wawahotpot/resources/views/frontend/modal.blade.php ENDPATH**/ ?>