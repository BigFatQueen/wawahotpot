              ...
              <div class="tab-content" id="myTabContent">
                <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                    ...
                    <div class="card shadow">
                      ...
                      <div class="card-img-top">
                         <img src="<?php echo e(asset('template/assets/img/theme/team-4-800x800.jpg')); ?>"  class="old-preview" width="216px" height="230px">
                       </div>
                ...
                <div class="tab-pane fade" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                    ...
                    <div class="card shadow">
                      ...
                      <div class="card-img-top">
                         <img src="<?php echo e(asset('template/assets/img/theme/team-4-800x800.jpg')); ?>"  class="new-preview" width="216px" height="230px">
                       </div>
  ...
  $(document).ready(function(){
   ...
   toastr.options.closeButton = true;
     ...
     $('#meat').DataTable({
                ...
                {data: 'DT_RowIndex'},
                     ...
                     render:function(data){
                      return `
                      <img src="<?php echo e(asset('${data}')); ?>" width = '80px' height = '100px'>
                      `
                     }}
                     ,
                {data:'name'},
    ...
    $('#meat').on('click','.btn-delete',function(){
     var id=$(this).data('id');
     url="<?php echo e(route('food.destroy',':id')); ?>";
    ...
    $('#meat').on('click','.btn-edit',function(){
      ...
      url="<?php echo e(route('food.edit',':id')); ?>";
      url=url.replace(':id',id);
     ...
     $.get(url,function(response){
      ...
      var img=`<?php echo e(asset('${response.photo}')); ?>`
    ...
    $('.meat-create-form').submit(function(e){
    	...
    	var formdata=new FormData(this);
    	var url="<?php echo e(route('food.store')); ?>";
    	$.ajax({
    		type:'POST',
    		url:url,
    		data:formdata,
          ...
          $('.name-pre').html('------');
          $('.price-pre').html('K$$$$');
          $('.preview').attr('src',"<?php echo e(asset('template/assets/img/theme/team-4-800x800.jpg')); ?>");
...
<?php echo $__env->make('backend/backend_template', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/prj/wawahotpot/resources/views/backend/menu/meat_index.blade.php ENDPATH**/ ?>